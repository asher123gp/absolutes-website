    ...
    return (
      <div className="max-w-[600px] w-full text-center form-stagger mx-auto">
        ...
        <p className="font-sans text-[1rem] leading-[1.8] text-ivory/70 font-light mb-12">
          Thank you. Your quotation request has been received. Our team will review your requirements and get back to you.
        </p>
        <Link 
          href="/"
    ...
    <div className="max-w-[1000px] mx-auto">
      <div className="form-stagger mb-16 border-b border-ivory/10 pb-12">
        ...
        <h1 className="font-serif text-[clamp(3rem,5vw,4.5rem)] leading-[1.1] tracking-[-0.02em] font-medium max-w-[800px]">
          Request a <em className="italic text-ivory/70 font-light">Quote</em>
        </h1>
        <p className="mt-6 font-sans text-[1rem] leading-[1.8] text-ivory/60 font-light max-w-[600px]">
          Provide your project requirements below to receive commercial pricing and availability information.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="form-stagger space-y-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
            <div className="flex flex-col gap-2 md:col-span-2">
              ...
              <input required name="product" value={formData.product} onChange={handleChange} placeholder="e.g. Cardamom Oil" className="bg-transparent border border-ivory/20 px-4 py-3 text-ivory focus:outline-none focus:border-brass transition-colors rounded-none" />
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              <label className="font-sans text-[0.75rem] text-ivory/80 uppercase tracking-widest">Quantity Required *</label>
              <input required name="quantityRequired" value={formData.quantityRequired} onChange={handleChange} placeholder="e.g. 25kg" className="bg-transparent border border-ivory/20 px-4 py-3 text-ivory focus:outline-none focus:border-brass transition-colors rounded-none" />
            </div>
            <div className="flex flex-col gap-2">
              <label className="font-sans text-[0.75rem] text-ivory/80 uppercase tracking-widest">Estimated Annual Requirement</label>
              <input name="annualRequirement" value={formData.annualRequirement} onChange={handleChange} placeholder="e.g. 500kg" className="bg-transparent border border-ivory/20 px-4 py-3 text-ivory focus:outline-none focus:border-brass transition-colors rounded-none" />
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-y-8">
            <div className="flex flex-col gap-2">
              <label className="font-sans text-[0.75rem] text-ivory/80 uppercase tracking-widest">Delivery Location *</label>
              <input required name="deliveryLocation" value={formData.deliveryLocation} onChange={handleChange} placeholder="City, Country / Zip Code" className="bg-transparent border border-ivory/20 px-4 py-3 text-ivory focus:outline-none focus:border-brass transition-colors rounded-none" />
            </div>
            <div className="flex flex-col gap-2">
              <label className="font-sans text-[0.75rem] text-ivory/80 uppercase tracking-widest">Required Specifications / Requirements</label>
              <textarea name="specifications" value={formData.specifications} onChange={handleChange} rows={3} className="bg-transparent border border-ivory/20 px-4 py-3 text-ivory focus:outline-none focus:border-brass transition-colors rounded-none resize-y" />
            </div>
            <div className="flex flex-col gap-2">
              <label className="font-sans text-[0.75rem] text-ivory/80 uppercase tracking-widest">Message</label>
              <textarea name="message" value={formData.message} onChange={handleChange} rows={3} className="bg-transparent border border-ivory/20 px-4 py-3 text-ivory focus:outline-none focus:border-brass transition-colors rounded-none resize-y" />
            </div>
          </div>
        </section>
