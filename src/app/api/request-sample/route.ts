...
export async function POST(request: Request) {
  try {
    ...
    const requiredFields = ['fullName', 'companyName', 'businessEmail', 'country', 'product', 'quantity', 'application', 'deliveryLocation'];
    ...
    const htmlContent = `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
        ...
        <h3 style="border-bottom: 1px solid #eee; padding-bottom: 10px;">NEW SAMPLE REQUEST — ${product}</h3>
        ...
        <h4 style="margin-top: 25px; color: #666; font-size: 12px; letter-spacing: 1px; text-transform: uppercase;">PRODUCT REQUIREMENT</h4>
    ...
    const subject = `New Sample Request — ${product || 'Website'}`;
